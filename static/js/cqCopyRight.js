...
//公司统一的版权号
+'			<p>'
+'				<span class="SDGCOPYRIGHT-pr3">All rights reserved.官方网站 版权所有 本游戏由【官方网站】开发运营</span>'
+'			</p>'
+'			<p class="SDGCOPYRIGHT-sdlogo">'
+'				<span class="SDGCOPYRIGHT-pr3">本网站设计及美工由<a href="#" target="_blank" title="腾飞美工" >sf005.com </a>独家设计制作</span>'
+'			</p>'
+'		</div>'
//右侧网络警察3个图标
...
+'			<span>'
+'<a href="#" target="_blank" title="传奇网站设计制作"><img src="images/1111pslogo.png" border=0></a>'
+'			</span>'
+'		</div>'
